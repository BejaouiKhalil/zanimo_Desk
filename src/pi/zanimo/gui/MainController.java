...
public class MainController implements Initializable {
    ...
    public void showAbout() {
        setStage("/modules/Rubriques.fxml",null);
    }

    @FXML
    private void showCompanies(MouseEvent event) {
        setStage("/modules/AddRubrique.fxml",null);

    }

    @FXML
    private void showCourse(MouseEvent event) {
        setStage("/modules/HomeForum.fxml",null);
    }

    @FXML
    private void showStudent(MouseEvent event) throws IOException {
        setStage("/modules/AddPost.fxml",null);
    ...
    private void showScheduling(MouseEvent event) throws IOException {
        setStage("/modules/readRubrique.fxml",null);
    }

    @FXML
    private void showTraining(MouseEvent event) throws IOException {
        setStage("/modules/Training.fxml",null);
    }

    @FXML
    private void synchroniseOnline(MouseEvent event) {
        setStage("/modules/Posts.fxml",null);
    }

    public void setStage(String fxml, String data) {
        try {
    ...
    private void showReports(MouseEvent event) {
        ...
        setStage("Cart.fxml",null);
        
    }

    @FXML
    private void showSettings(MouseEvent event) {
        setStage("Checkout.fxml","139");
    }

    @FXML
    private void showBackUps(MouseEvent event) {
        setStage("/modules/readPost.fxml",null);
    }
    ...
    @FXML
    private void cartShow(ActionEvent event){
        setStage("Cart.fxml",null);
    }
